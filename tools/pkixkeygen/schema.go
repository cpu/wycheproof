...
type PkixKeyDecodeSchemaJson struct {
	// The primitive tested in the test file
	Algorithm string `json:"algorithm"`
	...
	// Schema corresponds to the JSON schema field "schema".
	Schema PkixKeyDecodeSchemaJsonSchema `json:"schema"`

	// TestGroups corresponds to the JSON schema field "testGroups".
	TestGroups []PkixKeyDecodeTestGroup `json:"testGroups"`
}

type PkixKeyDecodeSchemaJsonSchema string

const PkixKeyDecodeSchemaJsonSchemaPkixKeyDecodeSchemaJson PkixKeyDecodeSchemaJsonSchema = "pkix_key_decode_schema.json"

var enumValues_PkixKeyDecodeSchemaJsonSchema = []interface{}{
	"pkix_key_decode_schema.json",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeSchemaJsonSchema) UnmarshalJSON(value []byte) error {
	var v string
	if err := json.Unmarshal(value, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_PkixKeyDecodeSchemaJsonSchema {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_PkixKeyDecodeSchemaJsonSchema, v)
	}
	*j = PkixKeyDecodeSchemaJsonSchema(v)
	return nil
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeSchemaJson) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	if _, ok := raw["algorithm"]; raw != nil && !ok {
		return fmt.Errorf("field algorithm in PkixKeyDecodeSchemaJson: required")
	}
	if _, ok := raw["header"]; raw != nil && !ok {
		return fmt.Errorf("field header in PkixKeyDecodeSchemaJson: required")
	}
	if _, ok := raw["notes"]; raw != nil && !ok {
		return fmt.Errorf("field notes in PkixKeyDecodeSchemaJson: required")
	}
	if _, ok := raw["numberOfTests"]; raw != nil && !ok {
		return fmt.Errorf("field numberOfTests in PkixKeyDecodeSchemaJson: required")
	}
	if _, ok := raw["schema"]; raw != nil && !ok {
		return fmt.Errorf("field schema in PkixKeyDecodeSchemaJson: required")
	}
	if _, ok := raw["testGroups"]; raw != nil && !ok {
		return fmt.Errorf("field testGroups in PkixKeyDecodeSchemaJson: required")
	}
	type Plain PkixKeyDecodeSchemaJson
	var plain Plain
	if err := json.Unmarshal(value, &plain); err != nil {
		return err
	}
	*j = PkixKeyDecodeSchemaJson(plain)
	return nil
}

// A group of PKIX key-decode test cases sharing the same algorithm, parameter set,
// and key encoding.
type PkixKeyDecodeTestGroup struct {
	// The cryptographic algorithm the encoded key is for (e.g. 'ML-DSA', 'RSA',
	// 'ECDSA', 'Ed25519').
	Algorithm string `json:"algorithm"`

	// The kind of key encoding tested: 'pkcs8' for a PKCS#8 PrivateKeyInfo (RFC 5208
	// / RFC 5958), 'spki' for a SubjectPublicKeyInfo (RFC 5280).
	KeyType PkixKeyDecodeTestGroupKeyType `json:"keyType"`

	// An algorithm-specific parameter selector (e.g. 'ML-DSA-44', 'secp256r1',
	// '2048'). Vectors within a group MUST share this value.
	...
	// Tests corresponds to the JSON schema field "tests".
	Tests []PkixKeyDecodeTestVector `json:"tests"`

	// Type corresponds to the JSON schema field "type".
	Type PkixKeyDecodeTestGroupType `json:"type"`
}

type PkixKeyDecodeTestGroupKeyType string

const PkixKeyDecodeTestGroupKeyTypePkcs8 PkixKeyDecodeTestGroupKeyType = "pkcs8"
const PkixKeyDecodeTestGroupKeyTypeSpki PkixKeyDecodeTestGroupKeyType = "spki"

var enumValues_PkixKeyDecodeTestGroupKeyType = []interface{}{
	"pkcs8",
	"spki",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeTestGroupKeyType) UnmarshalJSON(value []byte) error {
	var v string
	if err := json.Unmarshal(value, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_PkixKeyDecodeTestGroupKeyType {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_PkixKeyDecodeTestGroupKeyType, v)
	}
	*j = PkixKeyDecodeTestGroupKeyType(v)
	return nil
}

type PkixKeyDecodeTestGroupType string

const PkixKeyDecodeTestGroupTypePkixKeyDecode PkixKeyDecodeTestGroupType = "PkixKeyDecode"

var enumValues_PkixKeyDecodeTestGroupType = []interface{}{
	"PkixKeyDecode",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeTestGroupType) UnmarshalJSON(value []byte) error {
	var v string
	if err := json.Unmarshal(value, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_PkixKeyDecodeTestGroupType {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_PkixKeyDecodeTestGroupType, v)
	}
	*j = PkixKeyDecodeTestGroupType(v)
	return nil
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeTestGroup) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	if _, ok := raw["algorithm"]; raw != nil && !ok {
		return fmt.Errorf("field algorithm in PkixKeyDecodeTestGroup: required")
	}
	if _, ok := raw["keyType"]; raw != nil && !ok {
		return fmt.Errorf("field keyType in PkixKeyDecodeTestGroup: required")
	}
	if _, ok := raw["parameterSet"]; raw != nil && !ok {
		return fmt.Errorf("field parameterSet in PkixKeyDecodeTestGroup: required")
	}
	if _, ok := raw["source"]; raw != nil && !ok {
		return fmt.Errorf("field source in PkixKeyDecodeTestGroup: required")
	}
	if _, ok := raw["tests"]; raw != nil && !ok {
		return fmt.Errorf("field tests in PkixKeyDecodeTestGroup: required")
	}
	if _, ok := raw["type"]; raw != nil && !ok {
		return fmt.Errorf("field type in PkixKeyDecodeTestGroup: required")
	}
	type Plain PkixKeyDecodeTestGroup
	var plain Plain
	if err := json.Unmarshal(value, &plain); err != nil {
		return err
	}
	*j = PkixKeyDecodeTestGroup(plain)
	return nil
}

// A single PKIX key-decode test case. The encoded field is fed to the parser
// selected by the group's keyType. The result indicates expected parser behavior;
// this corpus tests parser acceptance only and does not assert anything about the
// recovered key material.
type PkixKeyDecodeTestVector struct {
	// A brief description of the test case
	Comment string `json:"comment"`

	// Hex-encoded bytes to be fed to the key parser.
	Encoded string `json:"encoded"`

	// A list of flags categorizing the mutation or property tested
	Flags []string `json:"flags"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *PkixKeyDecodeTestVector) UnmarshalJSON(value []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(value, &raw); err != nil {
		return err
	}
	if _, ok := raw["comment"]; raw != nil && !ok {
		return fmt.Errorf("field comment in PkixKeyDecodeTestVector: required")
	}
	if _, ok := raw["encoded"]; raw != nil && !ok {
		return fmt.Errorf("field encoded in PkixKeyDecodeTestVector: required")
	}
	if _, ok := raw["flags"]; raw != nil && !ok {
		return fmt.Errorf("field flags in PkixKeyDecodeTestVector: required")
	}
	if _, ok := raw["result"]; raw != nil && !ok {
		return fmt.Errorf("field result in PkixKeyDecodeTestVector: required")
	}
	if _, ok := raw["tcId"]; raw != nil && !ok {
		return fmt.Errorf("field tcId in PkixKeyDecodeTestVector: required")
	}
	type Plain PkixKeyDecodeTestVector
	var plain Plain
	if err := json.Unmarshal(value, &plain); err != nil {
		return err
	}
	*j = PkixKeyDecodeTestVector(plain)
	return nil
}
